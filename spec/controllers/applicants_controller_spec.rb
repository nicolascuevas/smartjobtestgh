...
RSpec.describe ApplicantsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: applicant.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      applicant = Applicant.create! valid_attributes
      get :edit, params: {id: applicant.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Applicant" do
        expect {
          post :create, params: {applicant: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {applicant: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested applicant" do
        applicant = Applicant.create! valid_attributes
        put :update, params: {id: applicant.to_param, applicant: new_attributes}, session: valid_session
        applicant.reload
      ...
      it "redirects to the applicant" do
        applicant = Applicant.create! valid_attributes
        put :update, params: {id: applicant.to_param, applicant: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        applicant = Applicant.create! valid_attributes
        put :update, params: {id: applicant.to_param, applicant: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested applicant" do
      applicant = Applicant.create! valid_attributes
      expect {
        delete :destroy, params: {id: applicant.to_param}, session: valid_session
      }.to change(Applicant, :count).by(-1)
    end
